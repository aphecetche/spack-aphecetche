...
class Libsigsegv(AutotoolsPackage, GNUMirrorPackage):
    ...
    patch('patch.vm_region', when='@2.12')
    ...
    # def patch(self):
    #     filter_file(r'# if defined __ppc64__ || defined __x86_64__',"# if defined __ppc64__ || defined __x86_64__ || defined __arm64__","src/stackvma-mach.c")
