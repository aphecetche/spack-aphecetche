...
class EnvironmentModules(Package):
    ...
    variant('binpath', default=True, description='Prepend binary directory to the PATH environment variable in the shell initialization scripts')
    ...
    def install(self, spec, prefix):
        ...
        if self.spec.satisfies('~binpath'):
            config_args.append('--disable-set-binpath')
