...
_versions = {
    '2020.11': {
        'Linux-x86_64': 'cf2ff493f11eaad5d09ce2b4feaa5ea90db5174303d5b3fe030e16d29aeef7de',
        'MacOSX-x86_64': 'ec11e325c792a6f49dbdbe5e641991d0a29788689176d7e54da97def9532c762'
    },
}
...
class Anaconda3(Package):
    ...
    for ver, packages in _versions.items():
      ...
      if pkg:
        url='https://repo.anaconda.com/archive/Anaconda3-{0}-{1}.sh'.format(ver,remote)
        version(ver,sha256=pkg,url=url,expand=False)
    ...
    conflicts('platform=darwin',when='@:6',msg='checksums not done for older versions on Darwin')
    conflicts('platform=darwin',when='@:2020.07',msg='checksums not done for older versions on Darwin')
